...
module rx_dphy_s_2lane (pll_lock_i, sync_clk_i, sync_rst_i, ready_o,
    ...
    reset_lp_n_i, reset_byte_fr_n_i, clk_p_io, clk_n_io, d_p_io, d_n_io,
    ...
    sp_en_o, lp_en_o, lp_av_en_o, rxdatsyncfr_state_o, rxemptyfr0_o,
    rxemptyfr1_o, rxfullfr0_o, rxfullfr1_o, rxque_curstate_o, rxque_empty_o,
    rxque_full_o, fifo_dly_err_o, fifo_undflw_err_o, fifo_ovflw_err_o)/* synthesis syn_black_box syn_declare_black_box=1 */;
    input  pll_lock_i;
    input  sync_clk_i;
    input  sync_rst_i;
    output  ready_o;
