...
module int_gpll (clki_i, 
    ...
    output clkop_o ; 
    output lock_o ; 
    int_gpll_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
            ...
            .FRAC_N_EN(0),
            .FBK_MODE("CLKOP"),
            .FBCLK_DIVIDER_ACTUAL_STR("4"),
            .SSC_N_CODE_STR("0b000000100"),
...
// Module : lscc_pll
//==========================================================================
module int_gpll_ipgen_lscc_pll #(parameter CLKI_FREQ = 100.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                int_gpll_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module int_gpll_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
