...
*******************************************************************************/
module tx_dphy_s_2lane (ref_clk_i, reset_n_i, pd_dphy_i, byte_or_pkt_data_i,
    ...
    d_p_io, d_n_io, pll_clkop_i, pll_clkos_i, pll_lock_i, sp_en_i, lp_en_i)/* synthesis syn_black_box syn_declare_black_box=1 */;
    input  ref_clk_i;
    input  reset_n_i;
    input  pd_dphy_i;
