create_clock -name {clk_2} -period 41.6666666666667 [get_ports clk_in]
create_clock -name {usb_clk} -period 16.6666666666667 [get_nets clk_60m]
...
create_clock -name {wb_clk} -period 10 [get_nets wb_clk]
...
set_clock_groups -group [get_clocks clk_2] -group [get_clocks usb_clk] -group [get_clocks hf_clk] -group [get_clocks lf_clk] -group [get_clocks wb_clk] -asynchronous
