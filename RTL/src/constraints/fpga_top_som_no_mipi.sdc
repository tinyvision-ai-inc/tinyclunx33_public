...
set_clock_groups -group [get_clocks clk_2] -group [get_clocks clk_60m] -group [get_clocks hf_clk] -group [get_clocks lf_clk] -group [get_clocks usb_clk] -asynchronous
