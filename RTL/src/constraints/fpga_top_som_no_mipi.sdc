...
create_clock -name {proc_clk} -period 10 [get_nets wb_clk]
...
set_clock_groups -group [get_clocks clk_2] -group [get_clocks proc_clk] -group [get_clocks hf_clk] -group [get_clocks lf_clk] -group [get_clocks usb_clk] -asynchronous
